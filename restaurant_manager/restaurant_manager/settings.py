...
SECRET_KEY = 'django-insecure-m(sn$oge)_y9mcsyc%me15^9q_enot5g$td_+ib974jz@roa2b'
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # Add in installed apps 
]
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Add in midleware
]
...
CORS_ALLOW_ALL_ORIGINS = True   # To allow all origins (for development purposes)
